...
exports.toolHooks = {
    ...
    str_replace: {
        ...
        after: [(0, hooks_js_1.truncateAfter)(exports.STR_REPLACE_RESULT_MAX_CHARS)],
    },
    delete_file: {
        maxOutputChars: exports.DELETE_FILE_RESULT_MAX_CHARS,
        before: [deleteFileBefore()],
        after: [(0, hooks_js_1.truncateAfter)(exports.DELETE_FILE_RESULT_MAX_CHARS)],
    },
    web_search: {
