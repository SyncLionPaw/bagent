...
async function setPendingContext(on) {
    await vscode.commands.executeCommand("setContext", "bagent54.pendingEdit", on);
}
...
function registerEditCommands(context) {
    context.subscriptions.push(vscode.commands.registerCommand("bagent54.acceptEdit", () => finishPending(true)), vscode.commands.registerCommand("bagent54.rejectEdit", () => finishPending(false)), vscode.workspace.onDidCloseTextDocument((doc) => {
