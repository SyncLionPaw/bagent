        ...
        while (true) {
            ...
            for (const call of assistant.tool_calls) {
                ...
                if ((0, editProposal_js_1.isEditTool)(name)) {
                    ...
                    const diagNote = (0, diagnostics_js_1.runDiagnosticAfterEdit)(proposal.path);
                    const applied = (0, editProposal_js_1.formatAppliedEdit)(proposal.path, proposal.newContent, diagNote || undefined);
                    yield {
                        type: "ToolResult",
                        name,
                        output: applied,
